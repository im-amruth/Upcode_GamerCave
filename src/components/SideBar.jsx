...
const SideBar = ({ sidebarOpen, setSidebarOpen }) => {
  // Mock location - replace with useLocation() from react-router-dom in your app
      ...
      >
        ...
        <div className="p-6 border-b border-[#00ff87]/10">
          ...
          <div className="flex gap-3 items-center justify-center">
            <div className="w-10 h-10 rounded-xl bg-linear-to-br from-[#00ff87] to-[#4ade80] flex items-center justify-center shadow-lg shadow-[#00ff87]/20">
        ...
        {/* Footer Section */}
        <div className="p-4 border-t border-[#00ff87]/10 bg-[#0d1410]">
